...
class BenchDragon:
    def __init__(self, moment):
        ...
        self.Nodes_lineared[1] = BenchDragonNode(341, 1, self.Head_linear_pos)
        for i in range(2, self.NodeSum+1):
            front_linear_pos_i = self.Nodes_lineared[i-1].back_linear_pos
            self.Nodes_lineared[i] = BenchDragonNode(220, i, front_linear_pos=front_linear_pos_i)
